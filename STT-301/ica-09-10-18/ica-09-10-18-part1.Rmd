...
20 * 30 # Multiplication

50 - 28 # Subtraction

30 ^ 4 # Rise to Power of

40 - 30 * ( 2 +1) # change the order of operations

log(100, base = 10) # logarithms and exponentia

sqrt(64) # Square root

round(3.67, digits = 2) # round to the nearest whole number

floor(4.56) # round down

ceiling(4.56) # round up
...
500 >=480 # greater or equal to

500 <=480 # less or equal to

(1 + 34) == (40 - 5) # equal to

FALSE != FALSE # not equal to
...
```{r}
# Give examples here
course_gpa = c(3.5, 4.0, 2.5, 4.0, 3.0, 3.5) # create course_gpa vector
sum(course_gpa) # get the sum of the values in the vector
mean(course_gpa) # get the mean GPA
length(course_gpa) # get how many courses did
```
