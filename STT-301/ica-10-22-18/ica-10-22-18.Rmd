...
First let's look at the data frame `flights`. Type `?flights` in your console to see the variables along with a brief description. The below code would be a bad idea if `flights` were an ordinary data frame, but it is a `tbl_df` object which has more intelligent display options. 
