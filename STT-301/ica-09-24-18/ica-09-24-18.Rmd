...
Using the definition of Q(p) , we can compute the p th quantile for specific values of p.
**See Equation in the 'ica-09-24-18 - Computational Methods for Data Science FS18-STT-301' PDF**
...
from a population known to follow a normal distribution. Let x_i(i = 1... n) be the observed random sample from a normal distribution. The maximum 
