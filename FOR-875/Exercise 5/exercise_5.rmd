...
gapminder$country[gapminder$G8 ==1]
```
...
As seen the G8 example above, `rep` is another very useful function for generating patterned data. The `rep` function replicates its first argument. Important arguments include `length.out`, `times`, and `each`. Some examples:
...
*Response... I dont Have Any questions*
...
*Response...*
*I think I am doing well. I found out that Chapter 5 was a little challenging because it is one of the longest chapter in the book so i had to go thorugh it a couple times*
